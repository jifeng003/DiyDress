...
namespace PaintIn3D
{
	...
	public class P3dPaintableTexture : MonoBehaviour
	{
		...
		public void SaveSXM()
		{
			...
			Debug.Log("存储"+ saveName + "内容" + PlayerPrefs.GetString(saveName));
		...
		public void Save(string saveName)
		{
			...
			{
				P3dCommon.SaveBytes(saveName, GetPngData());
				Debug.Log("存储"+ saveName + "内容" + PlayerPrefs.GetString(saveName),gameObject);
			}
		}
		...
		{
			Load(saveName);
			//Debug.Log("读取"+ saveName + "内容" + PlayerPrefs.GetString(saveName));
		}
		...
		public void Load(string saveName, bool replace = true)
		{
			if (activated == true)
			{
				...
				{
					Debug.Log("读取"+ saveName + "内容" + PlayerPrefs.GetString(saveName),gameObject);
		...
		[ContextMenu("ActivateSXM")]
		public void ActivateSXM()
		{
				Debug.Log("zhixing");
				paintable = GetComponentInParent<P3dPaintable>();
